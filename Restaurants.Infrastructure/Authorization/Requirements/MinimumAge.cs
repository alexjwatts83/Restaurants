...
{
    public int MinimumAge { get; private set; } = minAge;
}

internal class MinimumAgeRequirementHandler(IUserContext userContext, ILogger<MinimumAgeRequirementHandler> logger)
